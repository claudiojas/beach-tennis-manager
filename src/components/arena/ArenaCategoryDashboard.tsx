                ...
                >
                    ...
                    <div className="h-1/2 w-full flex flex-col pt-0 pb-4">
                        ...
                        {groups.length > 0 ? (
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center bg-slate-900/40 rounded-[3rem] border-4 border-dashed border-white/5 mx-2 md:mx-0">
                    ...
                    {/* Tela 2: Mata-Mata */}
                    <div className="h-1/2 w-full flex flex-col pt-4 md:pt-8 pb-4 relative">
